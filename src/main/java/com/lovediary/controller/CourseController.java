...
@Controller
public class CourseController extends Session {
    ...
    // 데이트 코스 카테고리 페이지
    @GetMapping("/course")
    public String coursePage(HttpServletRequest request,  Model model) {
    ...
    public String courseDetailPage(@PathVariable(name = "idx", required = false) Long idx,
                                   Model model) {
